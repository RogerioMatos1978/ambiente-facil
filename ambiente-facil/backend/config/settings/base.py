...
# Tolerância (minutos) após o fim de uma reserva para alertar o vigilante se a chave
# ainda não tiver sido devolvida na guarita (ver apps/keys/management/commands/
# alertar_chaves_atrasadas.py, agendado junto com o bloco acima).
CHAVE_TOLERANCIA_DEVOLUCAO_MINUTOS = config("CHAVE_TOLERANCIA_DEVOLUCAO_MINUTOS", default=10, cast=int)
